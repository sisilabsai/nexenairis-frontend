...
export default function Dashboard() {
  ...
  return (
    <ProtectedRoute>
      <DashboardLayout>
        {/* 🎯 Smart Dashboard Header with Variant Selector */}
        <div className="mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm font-medium text-red-800">
                      {criticalAlerts.filter((alert: any) => alert.type === 'critical').length} Critical Issues Require Immediate Attention
                    </h3>
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
              {executiveKPIs.map((kpi) => (
                <div key={kpi.id} className="bg-white overflow-hidden shadow-lg rounded-lg border-l-4 border-l-blue-500">
                  <div className="p-5">
                    <div className="flex items-center">
              ...
              <div className="lg:col-span-1 bg-white shadow-lg rounded-lg">
                ...
                <div className="px-6 py-4">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex items-end space-x-1 h-24 bg-gray-50 rounded-lg p-3">
                      {(
                      ...
                      {((topProductsData as any)?.length > 0 ? (topProductsData as any) : []).slice(0, 3).map((product: any, index: number) => (
                        <div key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                          <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm font-medium text-gray-900">{product.product_name || product.name}</span>
                          </div>
                          <div className="text-right">
                            <div className="text-sm font-bold text-gray-900">{product.total_quantity || product.sales || 0} units</div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm font-medium text-green-600">{`Fast (${(systemHealthData as any)?.data?.api_response_time || 120}ms)`}</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm font-medium text-green-600">{(systemHealthData as any)?.data?.database_status || 'Excellent'}</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700">Mobile Devices</span>
                      <div className="flex items-center">
                        <DevicePhoneMobileIcon className="h-4 w-4 text-green-500 mr-1" />
                        <span className="text-sm font-medium text-gray-900">{`${(systemHealthData as any)?.data?.mobile_devices_connected || 0} connected`}</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm font-medium text-gray-900">{`${(systemHealthData as any)?.data?.ai_services_active || 0} active`}</span>
                      </div>
                    </div>
                  </div>
                </div>
